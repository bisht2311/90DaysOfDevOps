...
3. Add a conditional step that only runs when the PR is **merged** (closed + merged = true)
  ...
  - Test it: create a PR, push an update to it, then merge it. Watch the workflow fire each time with a different event type.
   ...
   ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/pr_opened.png)

   ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/pr_sync.png)

   ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/pr_merged.png)

   ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/pr_closed.png)

   ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/pr_reopened.png)

   [PR-Lifecycle](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/962a30af93b693094f0ded88d5fc530bac5b1556/.github/workflows/pr-lifecycle.yml)
...
**Verify:** Open a PR from a badly named branch — does the check fail?
  ...
  ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/pr-check1.png)
  
  ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/pr-check2.png)
  
  ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/pr-check3.png)
  
  [PR-Checks](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/962a30af93b693094f0ded88d5fc530bac5b1556/.github/workflows/pr-check.yml)
...
- Why GitHub says scheduled workflows may be delayed or skipped on inactive repos
  ...
  ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/schedule.png)

[Schedule Trigger](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/962a30af93b693094f0ded88d5fc530bac5b1556/.github/workflows/scheduled-tasks.yml)
...
4. Test it: push a change to a `.md` file — does the workflow skip?
  ...
  ![images](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/smart-triggers1.png)
  
  ![images](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/smart-triggers2.png.png)

  [SmartTrigger](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/962a30af93b693094f0ded88d5fc530bac5b1556/.github/workflows/smart-triggers.yml)

  [PathIgnore](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/962a30af93b693094f0ded88d5fc530bac5b1556/.github/workflows/smart-triggers-ignore.yml)


5. When would you use `paths` vs `paths-ignore`?
...
**Verify:** Push a commit — does the test workflow run first, then trigger the deploy workflow?
  ...
  ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/tests1.png)

  ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/b0f936a7f9befa6524bbf59901c1368fc44a4b15/2026/day-47/image/tests2.png)

  [Test](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/962a30af93b693094f0ded88d5fc530bac5b1556/.github/workflows/tests.yml)

  [Deploy After Test](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/962a30af93b693094f0ded88d5fc530bac5b1556/.github/workflows/deploy-after-tests.yml)
...
5. When would an external system (like a Slack bot or monitoring tool) trigger a pipeline?
