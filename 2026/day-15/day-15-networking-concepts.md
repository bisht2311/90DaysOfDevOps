...
| ----------- | ------- | ------- |
| A           | Maps a domain to an IPv4 address | `example.com → 142.250.190.14` |
| AAAA        | Maps a domain to an IPv6 address | `example.com → 2001:4860:4860:0:0:0:0:8888` |
...
- Second column shows **TTL** (Time to Live, in seconds). 143 → cache IP for 143 seconds.  
- Last column shows the actual IPv4 addresses (A Records).
  ![dns_hostnames](https://github.com/bisht2311/90DaysOfDevOps/blob/8bc59ab914596e0b7fd01e2370f1f0e9a1b87773/2026/day-15/Day%2015%20-%20Snapshots/1.png)
...
- Example private IP: `172.31.13.236`

 ![](https://github.com/bisht2311/90DaysOfDevOps/blob/8bc59ab914596e0b7fd01e2370f1f0e9a1b87773/2026/day-15/Day%2015%20-%20Snapshots/2.png)
...
- Example: `22 → SSH`, `80 → HTTP`
 ...
 ![ss](https://github.com/bisht2311/90DaysOfDevOps/blob/8bc59ab914596e0b7fd01e2370f1f0e9a1b87773/2026/day-15/Day%2015%20-%20Snapshots/3.png)
