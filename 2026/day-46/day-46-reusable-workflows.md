...
**Verify:** This file alone won't run — it needs a caller. That's next.
   ...
   ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/4c915fb301c0ea5db8e11c9d1ba7d4e342ff3c90/2026/day-46/image/2.png)

   [reusable-workflow](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/f630dcd546f3f002cf7ba55e76f8ca8bc210f5d0/.github/workflows/reusable-build.yml)
...
**Verify:** In the Actions tab, do you see the caller triggering the reusable workflow? Click into the job — can you see the inputs printed?
  - Yes caller triggering the reusable workflow and also inputs printed
   ...
   ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/4c915fb301c0ea5db8e11c9d1ba7d4e342ff3c90/2026/day-46/image/3.png)

   [caller-workflow](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/f630dcd546f3f002cf7ba55e76f8ca8bc210f5d0/.github/workflows/call-build.yml)
...
**Verify:** Does the second job print the version from the reusable workflow?
   ...
   ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/4c915fb301c0ea5db8e11c9d1ba7d4e342ff3c90/2026/day-46/image/4.png)

   [reusable](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/f630dcd546f3f002cf7ba55e76f8ca8bc210f5d0/.github/workflows/reusable-build.yml)
...
**Verify:** Does your custom action run and print the greeting?
  ...
  ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/4c915fb301c0ea5db8e11c9d1ba7d4e342ff3c90/2026/day-46/image/5.png)

  [action](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/f630dcd546f3f002cf7ba55e76f8ca8bc210f5d0/.github/actions/setup-and-greet/action.yml) | [greet](https://github.com/bisht2311/bisht2311-githubactions_practise/blob/f630dcd546f3f002cf7ba55e76f8ca8bc210f5d0/.github/workflows/greet-composite-action.yml)
