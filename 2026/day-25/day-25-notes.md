...
1. Make 3 commits in your practice repo (commit A, B, C)
    ...
    ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/05703942e8685ba93cb4f145fa3985f6cffd3e19/2026/day-25/reset1.png)
...
2. Use `git reset --soft` to go back one commit — what happens to the changes?
    ...
    ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/05703942e8685ba93cb4f145fa3985f6cffd3e19/2026/day-25/reset2.png)
...
3. Re-commit, then use `git reset --mixed` to go back one commit — what happens now?
    ...
    ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/05703942e8685ba93cb4f145fa3985f6cffd3e19/2026/day-25/reset3.png)


4. Re-commit, then use `git reset --hard` to go back one commit — what happens this time?
    - It will say "working tree clean.

    ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/05703942e8685ba93cb4f145fa3985f6cffd3e19/2026/day-25/reset4.png)
...
1. Make 3 commits (commit X, Y, Z)
    ...
    ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/05703942e8685ba93cb4f145fa3985f6cffd3e19/2026/day-25/revert1.png)
...
3. Check `git log` — is commit Y still in the history?
    ...
    ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/05703942e8685ba93cb4f145fa3985f6cffd3e19/2026/day-25/revert2.png)
...
https://github.com/bisht2311/devops-git-practice/blob/main/git-commands.md
