...
[Repository - github-actions-capstone](https://github.com/bisht2311/github-actions-capstone/tree/main)
...
[Reusable Build & Test](https://github.com/bisht2311/github-actions-capstone/blob/f86bf8835250ead06029e1a5aa6e08d2203aed87/.github/workflows/reusable-build-test.yml)
...
[Reusable Docker Build & Push](https://github.com/bisht2311/github-actions-capstone/blob/f86bf8835250ead06029e1a5aa6e08d2203aed87/.github/workflows/reusable-docker.yml)
...
-   Only Tests run
    ...
    ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/edffe9926ee0f07e442da3824f707c19f8db9a8d/2026/day-48/image/4_1.png)
    
    ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/edffe9926ee0f07e442da3824f707c19f8db9a8d/2026/day-48/image/4_2.png)

    [PR Pipeline](https://github.com/bisht2311/github-actions-capstone/blob/f86bf8835250ead06029e1a5aa6e08d2203aed87/.github/workflows/pr-pipeline.yml)
...
**Verify:** Merge a PR to `main` — does it run tests → build Docker → deploy in sequence?
  ...
  - Yes Run test → build docker → deploy to production
    ...
    ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/edffe9926ee0f07e442da3824f707c19f8db9a8d/2026/day-48/image/5.png)

    [Main Pipeline - Deploy](https://github.com/bisht2311/github-actions-capstone/blob/f86bf8835250ead06029e1a5aa6e08d2203aed87/.github/workflows/main-pipeline.yml)
...
3. Add a step that creates a summary using `$GITHUB_STEP_SUMMARY`:
   ...
   ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/edffe9926ee0f07e442da3824f707c19f8db9a8d/2026/day-48/image/6.png)

   [Scheduled Health Check](https://github.com/bisht2311/github-actions-capstone/blob/f86bf8835250ead06029e1a5aa6e08d2203aed87/.github/workflows/health-check.yml)
...
> Every 12 Hours → **Health Check**
   ...
   ![image](https://github.com/bisht2311/90DaysOfDevOps/blob/edffe9926ee0f07e442da3824f707c19f8db9a8d/2026/day-48/image/7.png)
