...
## Revisit Weak Spots
Pick **topics** you marked as shaky and redo the hands-on tasks from that day.
...
3. Write a docker-compose.yml for a multi-container app.
    - Practiced Docker Compose by containerizing and managing a multi-container (3-tier) application, configuring services, networks, volumes, environment variables, and service dependencies through a `docker-compose.yml` file.
---
