...
![image](https://github.com/bisht2311/90DaysOfDevOps/blob/f789201cd59579df5884410f9f86e6f4f05b0840/2026/day-56/images/task1.png)
...
![image](https://github.com/bisht2311/90DaysOfDevOps/blob/f789201cd59579df5884410f9f86e6f4f05b0840/2026/day-56/images/task2.png)
...
- Pod names : `nginx-statefulset-0` `nginx-statefulset-1` `nginx-statefulset-2`
- PVC names : `nginx-stateful-vol-nginx-statefulset-0` `nginx-stateful-vol-nginx-statefulset-1` `nginx-stateful-vol-nginx-statefulset-2`

![image](https://github.com/bisht2311/90DaysOfDevOps/blob/f789201cd59579df5884410f9f86e6f4f05b0840/2026/day-56/images/task3.png)
...
![image](https://github.com/bisht2311/90DaysOfDevOps/blob/f789201cd59579df5884410f9f86e6f4f05b0840/2026/day-56/images/task4.png)
...
![image](https://github.com/bisht2311/90DaysOfDevOps/blob/f789201cd59579df5884410f9f86e6f4f05b0840/2026/day-56/images/task5.png)
...
![image](https://github.com/bisht2311/90DaysOfDevOps/blob/f789201cd59579df5884410f9f86e6f4f05b0840/2026/day-56/images/task6.png)
...
![image](https://github.com/bisht2311/90DaysOfDevOps/blob/f789201cd59579df5884410f9f86e6f4f05b0840/2026/day-56/images/task7.png)

---

## Key Takewaays

**1. What StatefulSets are and when to use them vs Deployments**
...
**2. Comparison Deployment vs StatefulSet**
...
**3. How Headless Services, stable DNS, and volumeClaimTemplates work**

1. `StatefulSet`
- Creates pods: nginx-statefulset-0, nginx-statefulset-1, nginx-statefulset-2
- Each pod has a fixed identity

2. `Storage (volumeClaimTemplates)`
    - Each pod gets its own PVC:
    - nginx-statefulset-0 -> nginx-stateful-vol-nginx-statefulset-0
    - nginx-statefulset-0 -> nginx-stateful-vol-nginx-statefulset-1
    - nginx-statefulset-0 -> nginx-stateful-vol-nginx-statefulset-2
...
- Each pod gets a stable DNS:
    ...
    - nginx-statefulset-0.nginx-headless-svc -> Pod IP
    - nginx-statefulset-1.nginx-headless-svc -> Pod IP
    - nginx-statefulset-2.nginx-headless-svc -> Pod IP
